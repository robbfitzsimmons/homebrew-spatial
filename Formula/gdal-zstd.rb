class GdalZstd < Formula
  desc "Geospatial Data Abstraction Library with ZSTD codec enabled"
  ...
  depends_on "robbfitzsimmons/spatial/libtiff-zstd"
  depends_on "sqlite"
  depends_on "unixodbc"
  depends_on "webp"
  depends_on "xerces-c"
  ...
  def install
    args = [
      ...
      "--with-libtiff=#{Formula["libtiff-zstd"].opt_prefix}",
      "--with-pg=yes",
